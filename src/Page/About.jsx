...
function About() {
  return (
    <>
              ...
              <div className="mt-2 md:mx-6">
                <div>
                  ...
                  <p className="text-blue-200 ">
                    Marketing Manager at Digitalden
                  </p>
                </div>
                <p className="mt-4 text-lg leading-relaxed text-white md:text-xl">
                  "The range of products is impressive, and I always find the
                  latest gadgets and tech accessories at unbeatable prices. What
                  really sets Digital Den apart, though, is their outstanding
                  customer service. Whenever I've had a question or needed help,
                  their team has been prompt and professional."
                </p>
              </div>
            </div>
          </main>
      ...
      {/* Client Saying */}
      <div className="px-5 py-2 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-6 lg:py-18">
        <div className="grid gap-6 row-gap-10 lg:grid-cols-2">
          <div className="lg:py-6 lg:pr-16">
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                ...
                <p className="text-gray-700">
                  Explore our vast collection of high-quality electronics from
                  top brands. Whether you're looking for the latest smartphone,
                  a reliable laptop, or trendy wearables, we've got you covered.
                </p>
              </div>
            </div>
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-lg font-bold">Unbeatable Prices</p>
                <p className="text-gray-700">
                  We offer competitive prices and frequent discounts to ensure
                  you get the best deals on the market.
                </p>
              </div>
            </div>
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                ...
                <p className="text-gray-700">
                  Enjoy fast and reliable shipping to your doorstep. We partner
                  with trusted carriers to ensure your products arrive safely
                  and on time.
                </p>
              </div>
            </div>
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-lg font-bold">Hassle-Free Returns:</p>
                <p className="text-gray-700">
                  Shop with peace of mind with our easy return policy. If you're
                  not completely satisfied with your purchase, we offer
      ...
      <section className="bg-dark dark:bg-gray-900">
        <div className="container px-4 py-2 mx-auto">
          <p className="font-sans font-bold tracking-tight text-gray-700 sm:text-2xl sm:leading-none">
            Trusted by
          </p>
      ...
      {/* Join Comunity */}
      <section className=" shadow-xl lg:py-12 mt-2 lg:flex lg:justify-center ">
        <div className="overflow-hidden bg-white dark:bg-gray-900 lg:mx-8 lg:flex lg:max-w-6xl lg:w-full lg:shadow-md lg:rounded-xl">
          ...
          <div className="max-w-xl px-6 py-12 lg:max-w-5xl lg:w-1/2">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">
              Join the Digital Den
              <span className="text-blue-500"> Community</span>
            </h2>
            <p className="mt-4 text-gray-500 dark:text-gray-300">
              Discover the future of online shopping at Digital Den, your
              ultimate destination for all things tech! We specialize in
              providing the latest and greatest in electronics, gadgets, and
              accessories to tech enthusiasts and everyday consumers alike. From
              cutting-edge smartphones and powerful laptops to smart home
              devices and gaming gear, Digital Den offers a diverse range of
              products to meet all your digital needs.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Email */}
      <section className="bg-white dark:bg-gray-900">
        <div className="container px-6 py-8 mx-auto lg:flex lg:items-center lg:justify-between">
