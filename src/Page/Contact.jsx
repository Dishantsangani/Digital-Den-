...
function Contact() {
  ...
  const validationform = () => {
    ...
    // Name Validation
    if (!formdata.name) {
      valdationError.name = "Username is required";
    }
    ...
    if (!formdata.message.trim()) {
      valdationError.message = "Textarea required";
    } else if (formdata.message.length < 12) {
      valdationError.message = "Message Should be at 12 Word";
    }
            ...
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
              <div className="text-white lg:w-1/2 lg:mx-6">
                ...
                <p className="max-w-xl mt-6">
                  At <span className="text-blue-500">Digital Den</span>, your
                ...
                <div className="mt-6 md:mt-8">
                  ...
                  <div className="flex mt-4 -mx-1.5 ">
                    ...
                    <a
                      className="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500"
                      href="https://www.facebook.com/share/18UWj2RG6U/?mibextid=wwXIfr"
                      target="_blank"
                    >
                      <svg
                        className="w-8 h-8"
                    ...
                    <a
                      className="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500"
                      href="https://www.instagram.com/dishant._27/"
                      target="_blank"
                    >
                      <svg
                        className="w-8 h-8"
